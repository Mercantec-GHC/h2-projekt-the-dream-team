...
namespace H2Projekt.Infrastructure.Migrations
{
    ...
    [Migration("20260225095634_DiscountPricePerNightDecimal")]
    partial class DiscountPricePerNightDecimal
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("H2Projekt.Domain.Booking", b =>
                {
                    ...
                    b.Property<bool>("TravelingWithPets")
            ...
            modelBuilder.Entity("H2Projekt.Domain.Booking", b =>
                {
                    ...
                    b.HasOne("H2Projekt.Domain.Room", "Room")
                        .WithOne("Booking")
                        .HasForeignKey("H2Projekt.Domain.Booking", "RoomId")
